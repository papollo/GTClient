...
function addToOptionsModule()
    ...
    chooseSkillComboBox:addOption('Two handed', 'club')
    chooseSkillComboBox:addOption('One handed', 'sword')
    chooseSkillComboBox:addOption('Bow Fighting', 'axe')
    chooseSkillComboBox:addOption('Crossbow Fighting', 'distance')
